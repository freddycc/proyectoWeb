...
class EstudiantesControllerTest < ActionController::TestCase
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post :create, estudiante: { apellidos: @estudiante.apellidos, cedula: @estudiante.cedula, email: @estudiante.email, id: @estudiante.id, nombre: @estudiante.nombre, password: @estudiante.password, username: @estudiante.username }
    end
  ...
  test "should update estudiante" do
    put :update, id: @estudiante, estudiante: { apellidos: @estudiante.apellidos, cedula: @estudiante.cedula, email: @estudiante.email, id: @estudiante.id, nombre: @estudiante.nombre, password: @estudiante.password, username: @estudiante.username }
    assert_redirected_to estudiante_path(assigns(:estudiante))
  end
