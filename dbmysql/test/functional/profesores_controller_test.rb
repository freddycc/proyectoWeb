...
class ProfesoresControllerTest < ActionController::TestCase
  ...
  test "should create profesore" do
    assert_difference('Profesore.count') do
      post :create, profesore: { apellido: @profesore.apellido, cedula: @profesore.cedula, email: @profesore.email, nombre: @profesore.nombre, password: @profesore.password, username: @profesore.username }
    end
  ...
  test "should update profesore" do
    put :update, id: @profesore, profesore: { apellido: @profesore.apellido, cedula: @profesore.cedula, email: @profesore.email, nombre: @profesore.nombre, password: @profesore.password, username: @profesore.username }
    assert_redirected_to profesore_path(assigns(:profesore))
  end
