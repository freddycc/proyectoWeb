...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { codigo: @curso.codigo, descripcion: @curso.descripcion, nombre: @curso.nombre }
    end
  ...
  test "should update curso" do
    put :update, id: @curso, curso: { codigo: @curso.codigo, descripcion: @curso.descripcion, nombre: @curso.nombre }
    assert_redirected_to curso_path(assigns(:curso))
  end
